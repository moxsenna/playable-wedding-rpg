// Verifies M1 build integrity: game package typechecks, web shell typechecks,
// production bundle builds with the WeddingWorld scene wired.
// Prints M1 BUILD VERIFIED only when every step exits 0.
...
const fail = (msg) => { console.error(`M1 build check FAILED: ${msg}`); process.exit(1); };
