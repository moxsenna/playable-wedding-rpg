// Verifies M12.5 build integrity: contracts + wedding-core + game + api +
// realtime + web typecheck, then realtime + api worker bundles render
// without deploying (wrangler deploy --dry-run, no account needed).
// Prints M125 BUILD VERIFIED only when every step exits 0.
...
console.log("M125 BUILD VERIFIED");
