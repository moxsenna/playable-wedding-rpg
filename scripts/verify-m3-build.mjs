// Verifies M3 build integrity: game package typechecks, web shell typechecks,
// production bundle builds with NPCs, dialogue panel, and demo bindings wired.
// Prints M3 BUILD VERIFIED only when every step exits 0.
...
const fail = (msg) => { console.error(`M3 build check FAILED: ${msg}`); process.exit(1); };
