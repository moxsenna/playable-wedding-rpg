// Verifies M4 build integrity: game package typechecks, web shell typechecks,
// production bundle builds with the Wedding Book, fixture, and gallery wired.
// Prints M4 BUILD VERIFIED only when every step exits 0.
...
const fail = (msg) => { console.error(`M4 build check FAILED: ${msg}`); process.exit(1); };
