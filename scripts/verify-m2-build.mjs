// Verifies M2 build integrity: game package typechecks, web shell typechecks,
// production bundle builds with the touch HUD wired.
// Prints M2 BUILD VERIFIED only when every step exits 0.
...
const fail = (msg) => { console.error(`M2 build check FAILED: ${msg}`); process.exit(1); };
