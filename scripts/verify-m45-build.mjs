// Verifies M4.5 build integrity: game package typechecks, web shell
// typechecks, production bundle builds with registry avatars wired.
// Prints M4.5 BUILD VERIFIED only when every step exits 0.
...
const fail = (msg) => { console.error(`M4.5 build check FAILED: ${msg}`); process.exit(1); };
...
console.log("M4.5 BUILD VERIFIED");
