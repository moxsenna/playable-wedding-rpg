...
if (!mainSrc.includes("bootstrapBindings") || !mainSrc.includes("/v1/guest/")) {
  fail("main.ts still fixture-only (no guest bootstrap)");
}
if (!mainSrc.includes("ensureAutoNet")) fail("main.ts missing realtime auto-boot");
...
if (!guestSrc.includes("/v1/guest/")) fail("guest page missing bootstrap fetch");
